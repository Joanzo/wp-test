...
<!-- Specific Page Data -->
<?php $title          = 'Shop Product List 2 Columns Left Sidebar - Multipurpose Responsinve HTML 5 Templates'; ?>
<?php $keywords       = 'HTML5 Template, CSS3, Elegant HTML Template, Ventech, Masonry, Font Awesome'; ?>
<?php $description    = '2 Columns Left Sidebar Modern Shopping Templates for Modern minimalist HTML 5 responsive templates for multipurpose use'; ?>
            ...
            <div class="content-title">
                <div class="container">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="pages-shop-2-columns-full.php">
                                2 Columns
                            </a>
                        </li>                        
                        <li class="active">
                    ...
                    <h1 class="title-text">
                        Sidebar Left 2 Columns Full Width
                    </h1>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8">
                        ...
                        <div class="stack-item center-table">
                            <div class="stack-content">
                                <div class="mgl-5 mgr-5">
                                    ...
                                    <button class="btn btn-default btn-line no-bd active" data-shop-list-toggle="grid" data-grid="2" data-target="#product-list-container">
                                        <i class="fa fa-th">
                                        </i>
                                    </button>
                ...
                <br/><br/>
                <div id="product-list-container" class="content-grid column-xl-2 column-lg-2 column-sm-2 column-xs-1 list-pd-10 wrap-side-10 list-hover product-list shop-grid"  data-gallery='{ "itemSelector": ".shop-item", "layoutMode": "fitRows" }'>
