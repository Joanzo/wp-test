...
<!-- Specific Page Data -->
<?php $title       = 'Gallery 2 Columns - Multipurpose Modern Minimal Responsive HTML 5 Templates'; ?>
<?php $keywords    = 'HTML5 Template, CSS3, Bootstrap theme, Technology Web Theme, Modern HTML Template, Ventech, Masonry'; ?>
<?php $description = '2 Columns Gallery for Multipurpose Modern Minimal Responsive HTML 5 Templates'; ?>
            ...
            <div class="content-title">
                <div class="container">
                    ...
                    <div class="subtitle-text">
                        Gallery starts with 2 columns down to 1.
                    </div>
                </div>
            </div>
        </div>
...
<section class="main-content full-layout">
    <div class="container">
        ...
        <ul class="content-grid column-sm-2 column-xs-1 list-pd-10 wrap-side-10" data-gallery='{ "itemSelector": ".list-item", "layoutMode": "fitRows" }'>
