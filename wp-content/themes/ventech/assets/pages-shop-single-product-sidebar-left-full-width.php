...
<!-- Specific Page Data -->
<?php $title       = 'Shop Single Product Sidebar Left Full Width -  Multipurpose Responsinve HTML 5 Templates'; ?>
<?php $keywords    = 'HTML5 Template, CSS3, Elegant HTML Template, Ventech, Masonry, Font Aweseome'; ?>
<?php $description = 'Single Product Sidebar Left Full Width Modern Shopping Templates for Modern minimalist HTML 5 responsive templates for multipurpose use'; ?>
        ...
        <div class="parallax-bg bg-tech-key" data-parallax="-.6">
            <div class="content-title">
                <div class="container">
                    ...
                    <h1 class="title-text">
                        Left Sidebar Single Product Full Width
                    </h1>
                    <div class="subtitle-text">
                        Single product with sidebar left
                    </div>
                </div>
            </div>
        </div>
