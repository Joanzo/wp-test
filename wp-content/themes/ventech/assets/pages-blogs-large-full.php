...
<!-- Specific Page Data -->
<?php $title          = 'Blog Large Full Layout - Multipurpose Modern Minimal Responsive HTML 5 Templates'; ?>
...
$active_submenu = 'large-blog-sub-full';
...
<div class="main-content pd-submenu full-layout">
    <div class="container">
        <div class="row">
            <div class="col-lg-7 col-md-8 mgb-xs-40 mgb-md-0">
