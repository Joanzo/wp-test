...
<!-- Specific Page Data -->
<?php $title       = 'Gallery Masonry - Multipurpose Modern Minimal Responsive HTML 5 Templates'; ?>
<?php $keywords    = 'HTML5 Template, CSS3, Bootstrap theme, Technology Web Theme, Modern HTML Template, Ventech, Masonry'; ?>
<?php $description = 'Masonry Gallery for Multipurpose Modern Minimal Responsive HTML 5 Templates'; ?>
...
<div class="main-content full-layout">
    <div class="container">
        ...
        <ul class="content-grid column-xl-5 column-lg-4 column-md-3 column-sm-2 column-xs-1 list-pd-15 wrap-side-15" data-gallery='{ "itemSelector": ".list-item", "layoutMode": "masonry" }'>
