...
<!-- Specific Page Data -->
<?php $title       = 'Features Header Style 8 - Multipurpose Modern HTML 5 Templates'; ?>
<?php $keywords    = 'HTML5 Template, CSS3, Modern HTML Template, Ventech, Masonry, Font Awesome'; ?>
<?php $description = 'Features Header Style 8 for Multipurpose Modern HTML 5 Templates'; ?>
            ...
            <div class="content-title">
                <div class="container">
                    ...
                    <div class="subtitle-text">
                        Header placed below section header sticky on scroll
                    </div>
                </div>
            </div>
        </div>
...
<!-- .section -->
<div class="header-height hidden-xs">
</div>
