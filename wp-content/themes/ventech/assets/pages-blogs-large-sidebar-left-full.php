...
<!-- Specific Page Data -->
<?php $title          = 'Blog Large Left Sidebar - Multipurpose Modern Minimal Responsive HTML 5 Templates'; ?>
<?php $keywords       = 'HTML5 Template, CSS3, Bootstrap theme, Technology Web Theme, Modern HTML Template, Ventech, Masonry'; ?>
<?php $description    = 'Large Blog with left sidebar full layout for Multipurpose Modern Minimal Responsive HTML 5 Templates'; ?>
<?php $active_menu    = 'menu-pages';   // To set active on the same id of primary menu ?>
<?php

// Specific Configuration for Page
$active_submenu = 'large-blog-sub-left-full';
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5 col-md-4">
                <div class="row">
                    <div class="col-lg-6 mgb-xs-40 mgb-lg-0">
