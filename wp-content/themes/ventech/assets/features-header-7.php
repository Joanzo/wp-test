...
<!-- Specific Page Data -->
<?php $title       = 'Features Header Style 7 - Multipurpose Modern HTML 5 Templates'; ?>
<?php $keywords    = 'HTML5 Template, CSS3, Modern HTML Template, Ventech, Masonry, Font Awesome'; ?>
<?php $description = 'Features Header Style 7 for Multipurpose Modern HTML 5 Templates'; ?>
            ...
            <div class="content-title">
                <div class="container">
                    ...
                    <div class="subtitle-text">
                        Transparent with submenu to sticky light header
                    </div>
                </div>
            </div>
        </div>
