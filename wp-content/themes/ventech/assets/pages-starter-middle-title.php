...
<!-- Specific Page Data -->
<?php $title       = 'Page Starter Middle Title - Multipurpose Modern Minimal Responsive HTML 5 Templates'; ?>
<?php $keywords    = 'HTML5 Template, CSS3, Bootstrap theme, Technology Web Theme, Modern HTML Template, Ventech, Masonry'; ?>
<?php $description = 'Starter Page Middle Title for Multipurpose Modern Minimal Responsive HTML 5 Templates'; ?>
...
<section class="section section-header">
    <div class="height-xs-5 height-md-6 pattern-image" >
            ...
            <div class="content-title">
                <div class="container">            
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="pages-starter-middle-content.php">
                                Starter
                            </a>
                        </li>                    
                    </ul>
                    <h1 class="title-text">
                        Middle Title Starter
                    </h1>
                </div>
            </div>
        </div>
...
<section class="main-content">
        <div class="container">
      		...
      		<h2 class="section-title">
                You can start your content here
            </h2>
