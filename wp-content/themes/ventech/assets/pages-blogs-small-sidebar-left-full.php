...
<!-- Specific Page Data -->
<?php $title       = 'Blogs Small Thumbs Sidebar left - Multipurpose Responsinve HTML 5 Templates'; ?>
<?php $keywords    = 'HTML5 Template, CSS3, Elegant HTML Template, Ventech, Masonry, Font Aweseome'; ?>
<?php $description = 'Blog Page Full layout for Modern minimalist HTML 5 responsive templates for multipurpose use'; ?>
<?php $active_menu = 'menu-pages';   // To set active on the same id of primary menu ?>
<?php

// Specific Configuration for Page
$active_submenu = 'small-blog-sub-left-full';
...
<?php include('templates/submenus/submenu-pages-blogs-small.tpl.php'); ?>
            ...
            <div class="col-lg-9 col-md-8">
                <div class="content-list list-lg list-break-xs  wrap-top">
                    ...
                    <article class="list-item">
                        ...
                        <div class="menu-item menu-icon">
                        	<div class="menu-i">
	                            <iframe class="iframe-block" height="300" src="https://www.youtube.com/embed/dKrVegVI0Us" allowfullscreen>
	                            </iframe>                        		
                        	</div>
                        </div>
                        <div class="menu-item menu-text">
