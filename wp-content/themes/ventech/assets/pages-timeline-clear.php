...
<!-- Specific Page Data -->
<?php $title          = 'Timeline Clear - Multipurpose Responsinve HTML 5 Templates'; ?>
<?php $keywords       = 'HTML5 Template, CSS3, Elegant HTML Template, Ventech, Masonry, Font Aweseome'; ?>
<?php $description    = 'Timeline Clear Page for Modern minimalist HTML 5 responsive templates for multipurpose use'; ?>
<?php $active_menu    = 'menu-pages';   // To set active on the same id of primary menu ?>
<?php

// Specific Configuration for Page
$active_submenu = 'timeline-sub-clear';
...
<section class="section section-header full-layout">
    <div class="height-xs-5 height-md-6" >
        <div class="parallax-bg bg-tech-key" data-parallax="-.9">
            <div class="content-title">
                <div class="container">
                    ...
                    <div class="subtitle-text">
                        Responsive timeline with information, clear theme
                    </div>
                </div>
            </div>
        </div>
...
<div class="main-content pd-submenu">
    <div class="container">
        <div class="timeline tl-primary mgb-xs-40 mgb-lg-0">
            <article class="tl-item active">
                <h2 class="tl-year text-primary-3">
                    2016
                </h2>
            </article>
            <article class="tl-item">
                <div class="tl-caption">
                    <div class="tl-panel">
                        <time datetime="2016-05-04" class="tl-date  bg-white">
                            <span class="date">
                                10
                            </span>
                            <span class="month">
