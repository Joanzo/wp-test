...
<!-- Specific Page Data -->
<?php $title       = 'Features Footer Full - Multipurpose Modern HTML 5 Templates'; ?>
<?php $keywords    = 'HTML5 Template, CSS3, Modern HTML Template, Ventech, Masonry, Font Awesome'; ?>
<?php $description = 'Features Footer Style Full for Multipurpose Modern HTML 5 Templates'; ?>
            ...
            <div class="content-title">
                <div class="container">
                    ...
                    <div class="subtitle-text">
                        Footer full layout, this can apply for all footer template
                    </div>
                </div>
            </div>
        </div>
