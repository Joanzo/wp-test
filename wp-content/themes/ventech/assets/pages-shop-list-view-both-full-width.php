...
<!-- Specific Page Data -->
<?php $title          = 'Shop Product List View Both Sidebar Full Width -  Multipurpose Responsinve HTML 5 Templates'; ?>
<?php $keywords       = 'HTML5 Template, CSS3, Elegant HTML Template, Ventech, Masonry, Font Aweseome'; ?>
<?php $description    = 'List View Both Sidebar Full Width Modern Shopping Templates for Modern minimalist HTML 5 responsive templates for multipurpose use'; ?>
            ...
            <div class="content-title">
                <div class="container">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="pages-shop-list-view-full.php">
                                List View
                            </a>
                        </li>                        
                        <li class="active">
                            Both Sidebar Full Width
                        </li>
                    </ul>
                    <h1 class="title-text">
                        Both Sidebar Product List View Full Width
                    </h1>
                    <div class="subtitle-text">
                        List view interchangable with grid view.
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row"> 
            ...
            <div class="col-lg-7 col-md-6  mgb-xs-40 mgb-md-0">
                        ...
                        <div class="stack-item center-table">
                            <div class="stack-content">
                                <div class="mgl-5 mgr-5">
                                    ...
                                    <button class="btn btn-default btn-line no-bd" data-shop-list-toggle="grid" data-grid="3" data-target="#product-list-container">
                                        <i class="fa fa-th">
                                        </i>
                                    </button>
                                    <button class="btn btn-default btn-line no-bd active"  data-shop-list-toggle="list" data-target="#product-list-container">
                ...
                <br/><br/>
                <div id="product-list-container" class="content-list list-lg list-break-sm list-pd-10 list-hover list-bordered product-list shop-list">
            ...
            <div class="col-lg-2 col-md-3  mgb-xs-40 mgb-md-0">
                <?php include('templates/sidebars/sidebar-shop-2.tpl.php'); ?>
            </div>
