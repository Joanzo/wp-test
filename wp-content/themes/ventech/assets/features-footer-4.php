...
<!-- Specific Page Data -->
<?php $title       = 'Features Footer Style 4 - Multipurpose Modern HTML 5 Templates'; ?>
<?php $keywords    = 'HTML5 Template, CSS3, Modern HTML Template, Ventech, Masonry, Font Awesome'; ?>
<?php $description = 'Features Footer Style 4 for Multipurpose Modern HTML 5 Templates'; ?>
