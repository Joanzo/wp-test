...
<!-- Specific Page Data -->
<?php $title       = 'Features Header Style Empty - Multipurpose Modern HTML 5 Templates'; ?>
<?php $keywords    = 'HTML5 Template, CSS3, Modern HTML Template, Ventech, Masonry, Font Awesome'; ?>
<?php $description = 'Features Header Style Empty for Multipurpose Modern HTML 5 Templates'; ?>
            ...
            <div class="content-title">
                <div class="container">
                    ...
                    <div class="subtitle-text">
                        Full layout header with only simple menu &amp; no logo
                    </div>
                </div>
            </div>
        </div>
