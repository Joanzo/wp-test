...
<!-- Specific Page Data -->
<?php $title          = 'Masonry Blog Sidebar Left - Multipurpose Modern Minimal Responsive HTML 5 Templates'; ?>
<?php $keywords       = 'HTML5 Template, CSS3, Bootstrap theme, Technology Web Theme, Modern HTML Template, Ventech, Masonry'; ?>
<?php $description    = 'Blog masonry style with sidebar left for Multipurpose Modern Minimal Responsive HTML 5 Templates'; ?>
<?php $active_menu    = 'menu-pages';   // To set active on the same id of primary menu ?>
<?php

// Specific Configuration for Page
$active_submenu = 'masonry-blog-left-full';
...
<?php include('templates/submenus/submenu-pages-blogs-masonry.tpl.php'); ?>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8">
                <div class="content-grid column-xs-1 column-sm-2 column-xl-3  list-pd-20 wrap-top-20 wrap-side-20"  data-gallery='{ "itemSelector": ".grid-item", "layoutMode": "masonry" }'>
                    <article class="list-item grid-item">
                        <div class="menu-item menu-icon pdb-20">
                            <div class="anim menu-i">
                                <a data-rel="prettyPhoto" href="img/blog/01.jpg" class="anim-link">
                                    <img src="img/blog/01.jpg" alt="example image" class="anim-img">
                    ...
                    <article class="list-item grid-item">
                        <div class="menu-item menu-icon  pdb-20">
                            <div class="anim menu-i">
                                <a data-rel="prettyPhoto" href="https://www.youtube.com/watch?v=dKrVegVI0Us" class="anim-link">
                                    <img src="img/blog/02.jpg" alt="example image" class="anim-img">
                                    <div class="anim-cover">
                                        <div class="anim-box">
                                            <div class="anim-border">
                                                <div class="anim-info">
                        ...
                        <div class="menu-item menu-text">
                            ...
                            <div class="blog-teaser-description">
                                Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua enim. Sed ut perspiciatis unde omnis iste natus error sit, totam rem aperiam, eaque ipsa quae ab illo inventore.  Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua enim. Sed ut perspiciatis unde omnis iste natus error sit, totam rem aperiam, eaque ipsa quae ab illo inventore...
                            </div>
                            <div class="blog-teaser-more">
                                <a class="btn btn-xs btn-primary btn-circle btn-line" href="#" data-toggle="tooltip" data-original-title="Read More">
                                    <i class="lnr lnr-arrow-right">
                    ...
                    <article class="list-item grid-item">
                        ...
                        <div class="menu-item menu-icon pdb-20">
                            <div class="menu-i">
                                ...
                                <div class="master-slider ms-skin-light-thin" data-list-slider="parallaxMask" data-arrow="false" data-autoplay="true">
                                    <div class="ms-slide">
                                        <img  src="img/blog/03.jpg" data-src="img/blog/03.jpg" alt="lorem ipsum dolor sit"/>
                                        <a data-rel="prettyPhoto[carousel-post]" href="img/blog/03.jpg">
                                        </a>

                                    </div>
                                    <div class="ms-slide">
                                        <img  src="img/blog/02.jpg" data-src="img/blog/02.jpg" alt="lorem ipsum dolor sit"/>
                                        <a data-rel="prettyPhoto[carousel-post]" href="img/blog/02.jpg">
                                        </a>
                                    </div>
                                    <div class="ms-slide">
                                        <img  src="img/blog/01.jpg" data-src="img/blog/01.jpg" alt="lorem ipsum dolor sit"/>
                                        <a data-rel="prettyPhoto[carousel-post]" href="img/blog/01.jpg">
                                        </a>
                                    </div>
                                </div>
                                <!-- end of masterslider -->
                        ...
                        <div class="menu-item menu-text">
                            ...
                            <div class="blog-teaser-description">
                                Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua enim...
                            </div>
                            <div class="blog-teaser-more">
                                <a class="btn btn-xs btn-primary btn-circle btn-line" href="#" data-toggle="tooltip" data-original-title="Read More">
                                    <i class="lnr lnr-arrow-right">
                    ...
                    <article class="list-item grid-item">
                        ...
                        <div class="menu-item menu-text">
                            ...
                            <div class="blog-teaser-description">
                                Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua enim. Sed ut perspiciatis unde omnis iste natus error sit, totam rem aperiam, eaque ipsa quae ab illo inventore. onsectetur adipisicing elit, sed do eiusmod tempor..
                            </div>
                            <div class="blog-teaser-more">
                                <a class="btn btn-xs btn-primary btn-circle btn-line" href="#" data-toggle="tooltip" data-original-title="Read More">
                                    <i class="lnr lnr-arrow-right">
                    ...
                    <article class="list-item grid-item">
                        ...
                        <div class="menu-item menu-icon pdb-20">
                            <iframe  class="iframe-block" height="240" src="https://www.youtube.com/embed/dKrVegVI0Us"  allowfullscreen>
                            </iframe>
                        </div>
                        <div class="menu-item menu-text">
                            <ul class="content-list list-md list-news">
