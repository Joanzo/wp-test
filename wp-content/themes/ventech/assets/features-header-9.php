...
<!-- Specific Page Data -->
<?php $title       = 'Features Header Style 9 - Multipurpose Modern HTML 5 Templates'; ?>
<?php $keywords    = 'HTML5 Template, CSS3, Modern HTML Template, Ventech, Masonry, Font Awesome'; ?>
<?php $description = 'Features Header Style 9 for Multipurpose Modern HTML 5 Templates'; ?>
...
<section class="section section-header boxed-layout">
            ...
            <div class="content-title">
                <div class="container">
                    ...
                    <div class="subtitle-text">
                        Minimalist header with light sticky theme
                    </div>
                </div>
            </div>
        </div>
