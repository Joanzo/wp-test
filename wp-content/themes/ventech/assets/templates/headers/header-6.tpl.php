...
<!-- Header Start -->
<header id="header" class="header-wrapper header-6 header-dark-sticky  <?php
 if(! $layout == 'boxed-layout') echo 'full-layout';  ?>" <?php if($header_sticky) echo 'data-spy="sticky"';  ?> data-offset-top=50 >
    <div class="top-heading top-style-right hidden-sticky hidden-xs">
        <div class="container">

            <div class="stack stack-xs stack-secondary">
                <div class="stack-group stack-main stack-right stack-top stack-break-md">
