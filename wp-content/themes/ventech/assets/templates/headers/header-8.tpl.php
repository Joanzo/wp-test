...
<header id="header" class="header-wrapper header-8 header-sm header-light bg-light-white  header-bottom header-light-sticky <?php
 if(! $layout == 'boxed-layout') echo 'full-layout';  ?> " <?php if($header_sticky) echo 'data-spy="sticky"';  ?> data-offset-top=".section-header" >
    <div class="container">
