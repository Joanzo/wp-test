...
<header id="header" class="header-wrapper header-10 header-bordered header-light-sticky" <?php if($header_sticky) echo 'data-spy="sticky"';  ?> data-offset-top="0" >
    <div class="container">
        <div class="stack stack-sm stack-primary">
            ...
            <div class="stack-group stack-right stack-top stack-break-md stack-content-break-sm menu-stack" id="menu-stack">
                ...
                <div class="stack-content">
                <a href="#" class="btn btn-success btn-line">
