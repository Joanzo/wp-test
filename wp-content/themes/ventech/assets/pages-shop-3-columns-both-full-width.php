...
<!-- Specific Page Data -->
<?php $title          = 'Shop Product List 3 Columns Both Sidebar Full Width - Multipurpose Responsinve HTML 5 Templates'; ?>
<?php $keywords       = 'HTML5 Template, CSS3, Elegant HTML Template, Ventech, Masonry, Font Aweseome'; ?>
<?php $description    = '3 Columns Both Sidebar Full Width Modern Shopping Templates for Modern minimalist HTML 5 responsive templates for multipurpose use'; ?>
        ...
        <div class="parallax-bg bg-tech-key" data-parallax="-.6">
            <div class="content-title">
                <div class="container">
                    ...
                    <h1 class="title-text">
                        Sidebar Both 3 Columns Full Width
                    </h1>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7 col-md-6  mgb-xs-40 mgb-md-0">
                        ...
                        <div class="stack-item center-table">
                            <div class="stack-content">
                                <div class="mgl-5 mgr-5">
                                    ...
                                    <button class="btn btn-default btn-line no-bd active" data-shop-list-toggle="grid" data-grid="3" data-target="#product-list-container">
                                        <i class="fa fa-th">
                                        </i>
                                    </button>
                ...
                <br/><br/>
                <div id="product-list-container" class="content-grid column-xl-3 column-lg-3 column-sm-2 column-xs-1 list-pd-10 wrap-side-10 list-hover product-list shop-grid"  data-gallery='{ "itemSelector": ".shop-item", "layoutMode": "fitRows" }'>
