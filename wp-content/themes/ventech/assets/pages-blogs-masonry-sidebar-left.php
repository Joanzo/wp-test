...
$active_submenu = 'masonry-blog-sidebar-left';
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8">
                <div class="content-grid column-xs-1 column-sm-2  list-pd-20 wrap-top-20 wrap-side-20"  data-gallery='{ "itemSelector": ".grid-item", "layoutMode": "masonry" }'>
