...
$active_submenu = 'masonry-blog-no-sidebar';
...
<div class="main-content pd-submenu">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="content-grid column-xs-1 column-sm-2 column-md-3 list-pd-20 wrap-top-20 wrap-side-20"  data-gallery='{ "itemSelector": ".grid-item", "layoutMode": "masonry" }'>
