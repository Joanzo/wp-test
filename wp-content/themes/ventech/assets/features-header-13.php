...
<!-- Specific Page Data -->
<?php $title       = 'Features Header No Sticky - Multipurpose Modern HTML 5 Templates'; ?>
<?php $keywords    = 'HTML5 Template, CSS3, Modern HTML Template, Ventech, Masonry, Font Awesome'; ?>
<?php $description = 'Features Header No Sticky for Multipurpose Modern HTML 5 Templates'; ?>
            ...
            <div class="content-title">
                <div class="container">
                    ...
                    <div class="subtitle-text">
                        Header without sticky features
                    </div>
                </div>
            </div>
        </div>
