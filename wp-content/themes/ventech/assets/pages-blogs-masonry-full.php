...
<?php $description    = 'Blog masonry style for Multipurpose Modern Minimal Responsive HTML 5 Templates'; ?>
<?php $active_menu    = 'menu-pages';   // To set active on the same id of primary menu ?>
<?php

// Specific Configuration for Page
$active_submenu = 'masonry-blog-full';
...
<div class="main-content pd-submenu full-layout">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="content-grid column-xs-1 column-sm-2 column-md-3 column-lg-4 list-pd-20 wrap-top-20 wrap-side-20"  data-gallery='{ "itemSelector": ".grid-item", "layoutMode": "masonry" }'>
